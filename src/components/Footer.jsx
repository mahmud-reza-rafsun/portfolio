...
function Footer() {
    ...
    return <footer className="py-10 px-4 sm:px-6 lg:px-8 font-inter relative overflow-hidden bg-gray-900/40">
        <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 200 200" width="48" height="48" className="coolshapes flower-3 mr-3 drop-shadow-lg">
                    <g clipPath="url(#cs_clip_1_flower-3)">
                        <mask id="cs_mask_1_flower-3" style={{
                            maskType: "alpha"
                        }} width="200" height="200" x="0" y="0" maskUnits="userSpaceOnUse">
            ...
            <nav className="mb-6 w-full">
                <ul className="flex flex-wrap justify-center gap-x-4 gap-y-1 text-base font-medium">
                    {navLinks.map(link => <li key={link.name}>
                        <a href={link.href} className="text-gray-600 dark:text-gray-400 hover:text-orange-500 dark:hover:text-orange-500 transition-all duration-300 relative after:absolute after:left-0 after:-bottom-1 after:h-0.5 after:w-0 after:bg-gray-900 dark:after:bg-orange-500 after:transition-all after:duration-300 hover:after:w-full">
                            {link.name}
                        </a>
                    </li>)}
                </ul>
            ...
            <p className="text-center text-xs text-gray-500 dark:text-gray-500 mt-4">
                &copy; {new Date().getFullYear()} rafsun. All rights reserved.
            </p>
        </div>
    </footer>;
}
